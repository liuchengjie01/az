...
def run(input_file, key, number, criteria, metadata, threads, label_map, out_dir='azoo_dataset', seed=None, ):
    ...
    try:
        ...
        DatasetDownloader(dataset=random_subset, out_dir=out_dir, key=key, threads=threads).download(number, label_map)
